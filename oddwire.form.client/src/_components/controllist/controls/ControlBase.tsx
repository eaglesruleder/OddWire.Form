...
type ControlBaseProps = Pick<CoreControlProps<unknown>, 'param' | 'label' | 'labelHeading' | 'hidden' | 'stacked' | 'value' | 'readonly' | 'cellClassName'> & {
    className?: string;
    ...
    return (
        <div className={rowClass}>
            ...
            <ControlHeadingLabel
                ...
                defaultHeading="h5"
                htmlFor={props.param}
                className={['control-label', props.labelClassName].filter(Boolean).join(' ')}
